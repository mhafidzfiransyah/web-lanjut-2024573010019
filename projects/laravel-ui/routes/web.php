...
Route::get('/switch-theme/{theme}', [UIController::class, 'switchTheme'])->name('switch-theme');https://github.com/Hayzarmuhaiyar0101/web-lanjut-2024573010100/blob/main/modul-4-laravel-ui/resources/views/about.blade.php